...
| `hoy dashboard [--port N]` | Browser dashboard at `http://127.0.0.1:N/` (default 8765) |
| `hoy daemon start --with-dashboard [--dashboard-port N]` | Run daemon and dashboard in one process |
